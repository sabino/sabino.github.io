...
- Doors: explicit open/closed state is shared. Closing over another connected traveler is rejected. Existing generated doorway collision rules are preserved.
